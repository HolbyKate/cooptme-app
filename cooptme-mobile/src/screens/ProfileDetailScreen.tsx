...
type ProfileDetailScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  "ProfileDetail"
>;
...
const styles = StyleSheet.create({
  ...
  photoPlaceholderText: { fontSize: 36, color: "#4247BD" },
  name: { fontSize: 24, color: "#333", marginBottom: 8 },
  function: { fontSize: 18, color: "#666", marginBottom: 12 },
  company: { fontSize: 16, color: "#666", marginBottom: 8 },
